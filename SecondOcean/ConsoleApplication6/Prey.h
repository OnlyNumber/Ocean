...
protected:
    ...
    virtual Cell* reproduce(Coordinate anOffset) { return this; }

public:
    Prey(int TimeToPeproduce = TIME_TO_REPRODUCE){
        this->TimeToReproduce = TimeToPeproduce;
        Image = DEFAULT_PREY_IMAGE;
    }

    virtual Cell* Copy(void) { return new Prey(TimeToReproduce); }

    virtual bool IsHunger(void) { return 0; }
    ...
    virtual void Reproduct(void) { TimeToReproduce = TIME_TO_REPRODUCE; }
